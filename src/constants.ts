...
/** Annotation required title message */
export const TITLE_REQUIRED_MESSAGE = `Don't forget your title`
/** Annotation title field maximum length. */
export const TITLE_MAX_LENGTH = 80
/** Annotation title max length error message */
export const TITLE_MAX_LENGTH_MESSAGE = `Title is too long. (${TITLE_MAX_LENGTH} characters max)`
/** Annotation note field (textarea) number of rows. */
export const NOTE_FIELD_ROWS = 6
/** Annotation note max length */
